...
$lang['Go to <a href="%s" target="_blank">%s</a> and create a new application'] = 'Перейти до <a href="%s" target="_blank">%s</a> і створити новий додаток';
$lang['Once you have registered, copy and past the created application credentials into this setup page'] = 'Після реєстрації скопіюйте і вставте реєстраційні дані додатку на сторінці налаштувань';
$lang['Based on OpenID'] = 'На основі OpenID';
$lang['No registration required'] = 'Не потрібна реєстрація';
$lang['Select these APIs: <b>Contacts</b> as <em>Read</em> and <b>Social Directory</b> as <em>Read Public</em>'] = 'Виберіть ці параметри API: <b>Контакти</b> в режимі <em>Читати</em> і <b>Соціальний каталог</b> як <em>Читати всім</em>';
...
$lang['Once the application is created, click <b>See application details</b>'] = 'Після того , як додаток створено , натисніть <b>Переглянути деталі додатку</b>';
$lang['Click on <b>Add Platform</b>, choose <b>Website</b> and set the <b>Site URL</b> to <em>%s</em>'] = 'Натисніть <b>Додати платформу</b>, виберіть <b>Веб-сайт</b> і встановіть <b>URL-адресу сайту</b> в <em>%s</em>';

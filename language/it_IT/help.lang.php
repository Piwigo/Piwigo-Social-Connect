...
$lang['On the <b>Create Client ID</b> popup, switch to advanced settings by clicking on <b>(more options)</b>'] = 'Sulla finestra popup <b>Create Client ID</b>, passare alle impostazioni avanzate, fare clic su <b>(more options)</ b>';
$lang['No registration required for OpenID based providers'] = 'Non è richiesta la registrazione per i providers OpenID base';

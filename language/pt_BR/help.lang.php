...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['On the <b>API Access</b> tab, <b>create an OAuth 2.0 Client ID</b>'] = 'No <b>acesso API</b>, <b>criar um Cliente ID OAuth 2.0</b>';
$lang['On the <b>Create Client ID</b> popup, switch to advanced settings by clicking on <b>(more options)</b>'] = 'No <b>Criar Cliente ID</b> pop-up, mudar para as configurações avançadas clicando no <b>(mais opções)</b>';
$lang['Once the application is registered update the permissions : set <b>Contacts</b> as <em>Read</em> and <b>Social Directory</b> as <em>Read Public</em>'] = 'Uma vez que o aplicativo está registrado, atualizar as permissões: configurar <b>Contatos</b> como <em>Leia</em> e <b>Diretório Social </b> como <em>Leitura Pública</em>';

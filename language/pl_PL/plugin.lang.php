...
$lang['Icon size on the identification page'] = 'Rozmiar ikony na stronie identyfikacyjnej';
...
$lang['%s: invalid keys'] = '%s: nieprawidłowe klucze';
$lang['An error occured, please contact the gallery owner. <i>Error code : %s</i>'] = 'Wystąpił błąd, proszę skontaktować się z właścicielem galerii. <i>Kod błędu: %s</i>';

...
$lang['Put your website domain in the %s fields. It should match with the current hostname: <em>%s</em>'] = 'Mettez votre nom de domaine dans les chmpas %s. Il doit correspondre à <em>%s</em>';

...
$lang['On the <b>API Access</b> tab, <b>create an OAuth 2.0 Client ID</b>'] = 'No separador <b>Acesso API</b>, <b>crie um Client ID OAuth 2.0</b>';
$lang['On the <b>Create Client ID</b> popup, switch to advanced settings by clicking on <b>(more options)</b>'] = 'No popup <b>Criar ID Cliente</b>, mude para definições avançadas clicando no <b>(mais opções)</b>';
$lang['Once the application is registered update the permissions : set <b>Contacts</b> as <em>Read</em> and <b>Social Directory</b> as <em>Read Public</em>'] = 'Assim que aplicação esteja registada actualize as permissões: defina <b>Contactos</b> como <em>Leitura</em> e <b>Directoria Social</b> como <em>Leitura Pública</em>';
